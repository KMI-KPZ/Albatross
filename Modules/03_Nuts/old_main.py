...
def show_data():
    ...
    # Data sources
    data = {
        "Level 1": produce_column_data(r"data/geojson/eurostats/nuts_rg_60M_2013_lvl_1.geojson"),
        "Level 2": produce_column_data(r"data/geojson/eurostats/nuts_rg_60M_2013_lvl_2.geojson"),
        "Level 3": produce_column_data(r"data/geojson/eurostats/nuts_rg_60M_2013_lvl_3.geojson")
    }
    options = [
        "Level 1",
        "Level 2",
